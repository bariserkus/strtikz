...
pvertical show last spring=0,
pvertical mirror springs=0,
pvertical space between springs=0.15cm,
pvertical space=0.0cm,
pvertical start ratio=0.1,
pvertical end ratio=0.1,
pvertical spring text={$t-z$ Spring},
pvertical text color=black,
pvertical text shiftx=0pt,
pvertical text shifty=0pt,
pvertical text location=above,
...
pile show frames=1,
pframe number=10,
pframe circle radius=1pt,
pframe line thickness=1pt,
pframe line color=blue,
pframe line type=dashed,
...
dof arr tip len/.store in = \dofarrtiplen,
dof arr tip wid/.store in = \dofarrtipwid,
...
phorizontal mirror springs/.store in =\phormirrorspring,
...
phorizontal text location/.store in = \phortextloc,
phorizontal spring length/.store in = \phorspringlength,
...
pvertical show last spring/.store in = \pvershowlastspring,
pvertical mirror springs/.store in = \pvermirrorspring,
pvertical space between springs/.store in = \pverspbtwspr,
...
pvertical text location/.store in = \pvertextloc,
...
pile show frames/.store in=\showpframes,
pframe number/.store in=\pframenumber,
pframe circle radius/.store in=\pframecirclerad,
pframe line thickness/.store in=\pframelinethk,
pframe line color/.store in=\pframelinecolor,
pframe line type/.store in=\pframelinetype,
...
\tikzmath{
int \showpframes, \pframenumber;
real \pframecirclerad, \pframelinethk;
...
real \arrowlenratio, \minlen, \dofxx, \dofyy, \arrlen, \arrrad, \doflinethickness;
real \dofxrotation, \dofyrotation, \dofrrotation, \dofarrtiplen, \dofarrtipwid;
...
int \showphorizontalsprings, \phorspringnumber, \phormirrorspring;
real \phorspringspace, \phorspringstartratio, \phorspringendratio;
real \phortextshiftx, \phortextshifty, \phorprelenratio, \phorpostlenratio;
real \phorsegm, \phorsprwid, \phorsprscale, \phorsprlinethk;
real \phorsuppwidth, \phorsuppdepth, \phorsupplinethk, \phorspringlength,
int \phorshowsuppshade;
int \showpverticalsprings, \pverspringnumber, \pvershowlastspring, \pvermirrorspring;
real \pverspringspace, \pverspringstartratio, \pverspringendratio;
real \pvertextshiftx, \pvertextshifty, \pverprelenratio, \pverpostlenratio;
real \pverampl, \pversegm, \pverspringscale, \pverspringthk;
real \pversuppwidth, \pversuppdepth, \pversupplinethk, \pverspbtwspr;
...
\pframecirclerad=\pframecirclerad;
\pframelinethk=\pframelinethk;
...
\startx = \startx;
\starty = \starty;
\doflinethickness=\doflinethickness;
\dofarrtiplen=\dofarrtiplen;
\dofarrtipwid=\dofarrtipwid;
\dofinnersepx=\dofinnersepx;
\dofinnersepy=\dofinnersepy;
\dofinnersepr=\dofinnersepr;
...
for \idefl in {\deflstart+1,...,{\levelnumber}}{
	\deflect{\idefl} = (\idefl-\deflstart)*\drift*\showdefl;
};
...
\ifthenelse{\showsupports=5}{
	...
	\ifthenelse{\showpiles=1}{
		...
		{\pilesupport[%
x coordinate=\pilecoordx{\pileind},
y coordinate=\pilecoordy,
pile depth=\piledepth,
pile diameter=\pilediameter,
pile line thickness=\pilelinethickness,
fill color=\pilefillcolor,
...
horizontal mirror springs=\phormirrorspring,
...
horizontal text location=\phortextloc,
horizontal spring length=\phorspringlength,
...
vertical show last spring=\pvershowlastspring,
vertical mirror springs=\pvermirrorspring,
vertical space between springs=\pverspbtwspr,
...
vertical text location=\pvertextloc,
...
show frames=\showpframes,
frame number=\pframenumber,
frame circle radius=\pframecirclerad,
frame line thickness=\pframelinethk,
frame line color=\pframelinecolor,
frame line type=\pframelinetype,]}
	}{}
...
length x = \arrlen,length y = \arrlen, dof line thickness=\doflinethickness,
...
dof arrow tip length=\dofarrtiplen, dof arrow tip width=\dofarrtipwid,
show dofx = \shodofx, show dofy = \shodofy, show dofr = \shodofr,
dofx position=\dofposx, dofy position=\dofposy, dofr position=\dofposr,
dofx inner sep=\dofinnersepx, dofy inner sep=\dofinnersepy,
...
offset rotation xdir=\dofrotoffsetx, offset rotation ydir=\dofrotoffsety,
start angle = \rotdofstartangle, end angle = \rotdofendangle, radius = \arrrad,
xstring = {$\dofdefaulttext_\dofcounterx$},
ystring = {$\dofdefaulttext_\dofcountery$},
rstring = {$\dofdefaulttext_\dofcounterz$},
font size = \normalsize, font scale = \doftextratio,
rotation=0, font rotation=0,
font rotation for x = \dofxrotation,
font rotation for y = \dofyrotation,
