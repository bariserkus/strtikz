...
\path[](\springstartcoordx,\springstartcoordy) -- ++(90+\springangle:\totalspringsupportlength) --
node[\loc,midway,sloped, xshift=\textshiftx, yshift=\textshifty, inner sep=1pt]{\springtext}
++(\springdxf,\springdyf);
