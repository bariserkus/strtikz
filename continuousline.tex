\pgfkeys{
 /continuousline/.is family, /continuousline,
  ...
  fill color a/.store in =\fillcolora,
  fill color b/.store in =\fillcolorb,
}
...
\filldraw[\fillcolora, draw=\fillcolora, line width=\linewid/2] (\midx{1}, \midy{1})
.. controls ++(\curvang{1}:\newcurvlen) and ++(\curvang{2}:\newcurvlen) ..
(\midx{2}, \midy{2}) -- cycle;

\filldraw[\fillcolorb, draw=\fillcolorb, line width=\linewid/2] (\midx{2}, \midy{2})
