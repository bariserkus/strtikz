...
load text scale/.store in = \loadtextscale,
...
real \loadxvalue, \loadyvalue, \loadtextscale;
...
node[\loc,midway,sloped, xshift=\textshiftx, yshift=\textshifty, scale=\loadtextscale]{\loadtext}
