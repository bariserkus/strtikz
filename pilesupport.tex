\pgfkeys{
 /pilesupport/.is family, /pilesupport,
  ...
  horizontal spring length/.store in=\horspringlength,
...
\horspringlength=\horspringlength;
\horsprwid=\horsprwid;
\horsegm=\horsegm;
...
\ifthenelse{\showaxialspring=1}{
	...
	node[anchor=west, inner sep=1pt, color=\axialtextcolor,
