\pgfkeys{
 /dofs/.is family, /dofs,
  ...
  dof line thickness/.store in = \doflinethk,
  font size/.store in = \doftextsize,
  font scale/.store in = \doftextscale,
  ...
  dofx position/.store in = \dofpositionx,
  dofy position/.store in = \dofpositiony,
  dofr position/.store in = \dofpositionr,
  dofx inner sep/.store in = \dofinsepx,
  dofy inner sep/.store in = \dofinsepy,
  dofr inner sep/.store in = \dofinsepr,
...
real \offsetdofx, \offsetdofy, \offsetrotx, \offsetroty, \doflinethk;
...
%%Fix for line line thickness
%\offsetdofx=\offsetdofx-\doflinethk;
%\lengthdofx = \lengthdofx+\doflinethk;
}
...
\draw [arrowdof, line width=\doflinethk] (\offsetdofx-\doflinethk/2,\offsetdofy) 
-- node[at end, inner sep=\dofinsepx, outer sep=0pt, anchor=180+\fontrotationx, pos=\dofpositionx, scale=\doftextscale]
{\doftextsize \xdoftext} ++(\lengthdofx,0);
}{;};
...
\draw [arrowdof, line width=\doflinethk] (\offsetdofx,\offsetdofy) 
-- node[at end, inner sep=\dofinsepy, outer sep=0pt, anchor=270+\fontrotationy, pos=\dofpositiony, scale=\doftextscale]
{\doftextsize \ydoftext} ++(0,\lengthdofy);
}{;};
...
%Draw z DOF
%\draw [arrowdof, line width=\doflinethk] (\offsetcenter,0) -- node[at end, inner sep=1pt, outer sep=0pt, anchor=180+\rotationdofcenter]{\doftextsize \xdoftext} ++(\lengthdofx,0);
%\draw [arrowdof, line width=\doflinethk] (0, \offsetcenter) -- node[at end, inner sep=1pt, outer sep=0pt, anchor=270+\rotationdofcenter]{\doftextsize \ydoftext}++(0,\lengthdofy);
\ifthenelse{\showdofr=1}{
\draw [arrowdof, line width=\doflinethk] (\rotdofstartang:\rotdofradius) ++(\offsetrotx,\offsetroty)
arc [start angle=\rotdofstartang, end angle=\rotdofendang, radius=\rotdofradius]
node[at end, inner sep=\dofinsepr, outer sep=0pt, anchor=\rotdofendang+\fontrotationr-90, pos=\dofpositionr, scale=\doftextscale]
{\doftextsize \rotdoftext};
}{;};

\ifthenelse{\showdofr=-1}{
\draw [arrowdof, line width=\doflinethk] (\rotdofendang:\rotdofradius) ++(\offsetrotx,\offsetroty)
