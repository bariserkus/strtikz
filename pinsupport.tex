\pgfkeys{
 /pinsupport/.is family, /pinsupport,
  ...
  show support shade/.store in=\showsupportshade,
  support shade color/.store in=\supportshadecolor,
...
real \rad;
int \showcircle, \showsupportshade;
...
\begin{scope}[x=1pt, y=1pt, xshift=\xvalue, yshift=\yvalue, rotate=\rotpin];    % Draw everything in pt units
...
\ifthenelse{\showsupportshade=1}{
	\fill [\supportshadecolor] (-\linew/2, -\triw-\lined) rectangle (+\linew/2, -\triw);
}{;}
